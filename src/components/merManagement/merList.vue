        ...
        <div class="enter-wrapper">
            ...
            <div class="table">
                <el-table :data="tableData" border style="width: 100%" size="small">
                    ...
                    <el-table-column property="account_name" label="姓名" width="80" align="center"></el-table-column>
                    <el-table-column property="account_no" label="银行卡号" width="160" align="center"></el-table-column>
                    <el-table-column property="recevie_bank" label="备付金账户标识" width="120" align="center"></el-table-column>
                    <el-table-column property="money" label="金额" width="120" align="center"></el-table-column>
                    <el-table-column property="type" label="类型" width="120" align="center"></el-table-column>
                    <el-table-column property="status" label="状态" width="120" align="center"></el-table-column>
                    <el-table-column property="create_time" label="创建时间" width="170" align="center"></el-table-column>
                    <el-table-column
                        label="操作"
                        align="center"
                        >
